                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    <div class="brand-logo pb-5">
                        <a href="html/index.html" class="logo-link">
                            <img class="logo-light logo-img logo-img-lg" src="./assets/images/logo.png" srcset="./assets/images/logo.png" alt="looo">
                            <img class="logo-dark logo-img logo-img-lg" src="./assets/images/logo.png" srcset="./assets/images/logo.png" alt="loo-dark">
                        </a>
                    </div>
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                <div class="nk-feature-img">
                                    <img class="round" src="./assets/images/banner1.png" srcset="./assets/images/banner1.png" alt="">
                                </div>
